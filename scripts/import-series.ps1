...
Write-Host "Starting import of $($titles.Count) series..." -ForegroundColor Green
...
for ($batchIndex = 0; $batchIndex -lt $batchCount; $batchIndex++) {
    ...
    Write-Host "Processing batch $($batchIndex + 1)/$batchCount ($($batch.Count) series)..." -ForegroundColor Cyan
    ...
    try {
        ...
        Write-Host "  Imported: $($result.imported) | Skipped: $($result.skipped) | Failed: $($result.failed)" -ForegroundColor Green
...
$totalAttempted = $totalImported + $totalSkipped + $totalFailed
