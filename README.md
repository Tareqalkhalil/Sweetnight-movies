...
منصة مشاهدة الأفلام والمسلسلات المبنية بـ Next.js + Prisma + PostgreSQL (Supabase قابلة للتشغيل)
...
- قاعدة البيانات محلية PostgreSQL مع إعداد Supabase جاهز للنشر
